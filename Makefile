...
ifeq ($(OS_TYPE), linux)	
	...
	cd $$PWD/image && linuxkit run -publish 6443:6443 -publish 50091:50091 -disk size=4G --mem 4096 kube-master.iso  
else
	...
	cd $$PWD/image && linuxkit run --mem 4096 -disk size=4G -publish 6443:6443 -publish 50091:50091 -iso --uefi kube-master-efi.iso
endif
